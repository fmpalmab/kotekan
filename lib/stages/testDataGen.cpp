...
testDataGen::testDataGen(Config& config, const std::string& unique_name,
    ...
    assert(type == "const" || type == "const_offset" || type == "const8" || type == "const8u"
           || type == "const1x8" || type == "const16" || type == "const32" || type == "constf16"
           || type == "random" || type == "random_signed" || type == "random_signed_offset"
           || type == "random1x8" || type == "ramp" || type == "tpluse" || type == "tpluseplusf"
    ...
    if (type == "const_offset")
        type_size = 1;
    if (type == "const8" || type == "const8u" || type == "const1x8")
        type_size = 1;
    if (type == "const16")
        type_size = 2;
    if (type == "const32")
    ...
    if (type == "constf16")
        type_size = 2;
    if (type == "const" || type == "const_offset" || type == "const8" || type == "const8u"
...
void testDataGen::main_thread() {
    ...
    while (!stop_thread) {
        ...
        } else if (type == "const8u") {
            n_to_set /= sizeof(uint8_t);
            frame8u = (uint8_t*)frame;
            if (chordmeta)
        ...
        if (_value_array.size()
            && ((type == "const") || (type == "const_offset") || (type == "const8")
                || (type == "const8u") || (type == "const1x8") || (type == "const16")
                || (type == "const32")))
